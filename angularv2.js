    ...
    function mainControl(){
        ...
        function profileController($scope,userData,$location){
            if(sessionStorage.getItem("currentUser")===null||userData.currentUser===null){
                ...
                $scope.changeUnameEmpty=false;
                $scope.changePswdEmpty=false;
                ...
                $scope.submitEdit=function(username,password,name,email,phone,location){
                    if(username===""||password===""){
                        if(username===""){
                            $scope.changeUnameEmpty=true;
                        }
                        if(password===""){
                            $scope.changePswdEmpty=true;
                        }
                    }else{
                        $scope.changeUnameEmpty=false;
                        $scope.changePswdEmpty=false;
        ...
        function viewMsgController($scope,$location,userData){
            if(userData.currentMsg===null||sessionStorage.getItem("currentUser")===null){
                $location.path('/');
            }else{
